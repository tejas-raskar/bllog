...
export const AppBar = ({ type = "main", publish, save, editor }: {
    type: "main" | "editor",
        ...
        <div className="flex justify-center">
            {type === "main" ? <div className="flex flex-col justify-center"><Link to={'/create'}>
                ...
                <div className="flex justify-center">
                    ...
                    {isTryEditor ? (
                        <Button size="sm" className="flex items-center gap-2 mr-2 p-3 lg:p-3 rounded-full shadow-none hover:shadow-none bg-black text-white" onClick={() => window.location.href = '/signup'} placeholder="" onPointerEnterCapture={() => { }} onPointerLeaveCapture={() => { }}>
